...
<head>
    ...
    <link rel="stylesheet" href="Public/style/products-productmanager.css">
...
<!-- Header--------------------------------------------------------- -->
            ...
            <div class="d-flex flex-column product-manager" id="productManager">
                <div class="d-flex flex-row category">
                    <div class="d-flex search">
                        <input type="text" placeholder="Name" id = "nameSearch" value="">
    ...
    <!-- Script----------- -->
<footer>
    <script src="Public/javascript/products-productmanager.js"></script>
