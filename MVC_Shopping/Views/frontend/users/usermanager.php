...
<head>
    ...
    <link rel="stylesheet" href="Public/style/users-usermanager.css">
...
<body>
    <div class="body-page">
        <div class="container">
            ...
            <div class="row " id="userManager">
                <div class="col-12 d-flex flex-row category">
                    <div class="d-flex flex-row search">
                        <input type="text" placeholder="Username or Phone Number" id = "usernamesdt" value="">
                        <button id="search">Search</button>
                    </div>
                    <div class="d-flex flex-row new">
                        <button id="new">New</button>
                    </div>
                </div>
                <div class="col-12 d-flex flex-column main" id="main">
    ...
    <!-- Script----------- -->
<footer>
    <script src="Public/javascript/users-usermanager.js"></script>
